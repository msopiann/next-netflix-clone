...
export default function Header() {
  ...
  const navbarClass = isMobile
    ? "navbar fixed bottom-0 block inset-x-0 justify-between w-full h-[4.5rem] p-4 bg-black z-10"
    : "navbar fixed top-0 flex justify-between w-full h-[4.5rem] p-4 bg-transparent z-10";
  ...
  return (
    <nav className={navbarClass}>
      ...
      <div className="flex justify-between space-x-4 md:hidden">
        <Link
          href="/"
          className="w-full text-red-600 focus:text-red-600 hover:text-white justify-center inline-block text-center pt-2 pb-1"
        >
          <svg
            width="25"
            height="25"
        ...
        <Link
          href="/"
          className="w-full focus:text-red-600 hover:text-red-600 justify-center inline-block text-center pt-2 pb-1"
        >
          <svg
            width="25"
            height="25"
